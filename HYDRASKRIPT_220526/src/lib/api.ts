...
// All requests use relative paths and include user email for auth

const API_BASE = '/api';

// Simple auth: store email in localStorage
// In production, this would use proper auth tokens
export function getUserEmail(): string {
  if (typeof window === 'undefined') return 'demo@hydraskript.com';
  return localStorage.getItem('hydraskript_email') || 'demo@hydraskript.com';
}

export function setUserEmail(email: string): void {
  localStorage.setItem('hydraskript_email', email);
}
