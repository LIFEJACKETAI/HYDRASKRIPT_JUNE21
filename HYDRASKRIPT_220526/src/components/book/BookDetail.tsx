...
const statusConfig: Record<string, { label: string; className: string }> = {
  ...
  generating: { label: 'Generating', className: 'bg-purple-500/20 text-purple-300 border-purple-500/30' },
  ...
  return (
    ...
    >
        ...
        <div className="md:col-span-2 space-y-4">
          ...
          {book.outline && (
            <Card className="bg-[#2a2a2a] border-gray-800">
              ...
              <CardContent>
                <p className="text-sm text-gray-300 whitespace-pre-wrap leading-relaxed">{book.outline}</p>
              </CardContent>
            </Card>
          )}
        </div>
      ...
      <Card className="bg-[#2a2a2a] border-gray-800">
        ...
        <CardContent>
          <ChapterEditor chapters={book.chapters || []} />
        </CardContent>
      </Card>
      ...
      <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <DialogContent className="bg-[#1a1a1a] border-gray-800 text-white">
          ...
          <DialogFooter>
            <Button variant="ghost" onClick={() => setShowDeleteDialog(false)} className="text-gray-400">
              Cancel
            </Button>
