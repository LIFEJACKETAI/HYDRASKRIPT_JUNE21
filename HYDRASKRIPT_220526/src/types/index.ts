...
export const CREDIT_COSTS: CreditCostTable = {
  chapterPerThousandWords: 1,   // 1 credit per 1000 words (affordable)
  image: 2,                     // 2 credits each
  audiobookBase: 10,            // 10 credits base
  audiobookPerMinute: 1,        // 1 credit per minute
  exportPdf: 1,                 // 1 credit
  outlineGeneration: 1,         // 1 credit
};
...
export const AUDIENCE_CONFIG: Record<TargetAudience, { maxPages: number; defaultChapters: number; wordsPerChapter: number; illustrationStyle: string }> = {
  'adult':    { maxPages: 600, defaultChapters: 5,  wordsPerChapter: 1500, illustrationStyle: 'none' },
  '10-14':    { maxPages: 25,  defaultChapters: 5,  wordsPerChapter: 800,  illustrationStyle: 'pixar' },
  '6-9':      { maxPages: 15,  defaultChapters: 5,  wordsPerChapter: 400,  illustrationStyle: 'pixar' },
  '0-5':      { maxPages: 8,   defaultChapters: 5,  wordsPerChapter: 80,   illustrationStyle: 'pixar' },
};
...
export const TIER_CONFIG: Record<Tier, { credits: number; price: number; label: string }> = {
  starter: { credits: 100, price: 0, label: 'Starter (Free)' },
  author: { credits: 500, price: 9.99, label: 'Author' },
  publisher: { credits: 2000, price: 29.99, label: 'Publisher' },
  studio: { credits: 10000, price: 99.99, label: 'Studio' },
};
